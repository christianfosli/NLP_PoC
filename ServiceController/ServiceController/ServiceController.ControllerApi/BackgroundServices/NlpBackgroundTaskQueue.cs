...
{
	public class NlpBackgroundTaskQueue : INlpBackgroundTaskQueue
	{
		private readonly Channel<Func<CancellationToken, ValueTask>> _queue;

		public NlpBackgroundTaskQueue(int capacity)
		{
		...
		public async ValueTask<Func<CancellationToken, ValueTask>> DequeueBackgroundWorkItem(CancellationToken cancellationToken)
		{

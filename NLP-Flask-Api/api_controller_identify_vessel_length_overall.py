...
def create_api_response_for_post_identify_vessel_length_overall_in_text_service_norwegian_chapter_input(title_dictionary,forward_filtered_result_with_only_the_things_we_are_looking_for):
    ...
    for line in forward_filtered_result_with_only_the_things_we_are_looking_for:
        ...
        if "chapter_title" in title_dictionary:
            merged_line_result['chapter_title'] = title_dictionary['chapter_title']
        if "section_title_in_dictionary" in title_dictionary:
            ...
            if text_service_url in section_title_dictionary:
                merged_line_result['section_title'] = section_title_dictionary[text_service_url]

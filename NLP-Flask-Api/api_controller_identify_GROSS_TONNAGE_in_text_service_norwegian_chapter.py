...
def create_api_response_for_post_identify_GROSS_TONNAGE_in_text_service_norwegian_chapter(title_dictionary,forward_filtered_result_with_only_the_things_we_are_looking_for):
        ...
        for ent_index_number, ent in enumerate(ents):
            ...
            if ent_label == "GROSS_TONNAGE":
                ...
                if "til" in ent_text:
                    ...
                    detection_with_url_metadata["gross_tonnage_context"] = ent_doc[1].text + " til"
                    detection_with_url_metadata["gross_tonnage_value_1"] = ent_doc[words_in_doc_count-1].text
                    detection_with_url_metadata["measurement_text"] = ent_doc[0].text
                    ...
                    detection_with_url_metadata = dict(metadata_from_url)
                    detection_with_url_metadata["gross_tonnage_context"] = ent_doc[1].text
                    detection_with_url_metadata["gross_tonnage_value_1"] = ent_doc[words_in_doc_count-1].text
                    detection_with_url_metadata["measurement_text"] = ent_doc[0].text
                    forward_result.append(detection_with_url_metadata)
                    ...
                    detection_with_url_metadata = dict(metadata_from_url)
                    detection_with_url_metadata["gross_tonnage_context"] = "eller " + ent_doc[words_in_doc_count-1].text
                    detection_with_url_metadata["gross_tonnage_value_1"] = ent_doc[1].text
                    detection_with_url_metadata["measurement_text"] = ent_doc[0].text
                    forward_result.append(detection_with_url_metadata)

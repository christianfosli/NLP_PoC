...
def create_api_response_for_post_identify_CARGO_in_text_service_norwegian_chapter(title_dictionary,forward_filtered_result_with_only_the_things_we_are_looking_for):
    ...
    for line in forward_filtered_result_with_only_the_things_we_are_looking_for:
        ...
        for ent_index_number, ent in enumerate(ents):
            ...
            if ent_label == "CARGO":
                ...
                detection_with_url_metadata["cargo_text"] = ent_text
